...
void Intro(){
	string a;
	ifstream file("E:\\Bài\\Code\\do an\\lammau.txt");
	while(!file.eof()){
		getline(file, a);		
		cout << a << endl;
	}
...
void SaveMayBay(AirPlanes DSMB){
	fstream fileOut1("E:\\Bài\\Code\\do an\\maybay.txt", ios::out | ios::binary);
	for (int i = 0; i < DSMB.n; i++)
...
void LoadMayBay(AirPlanes &DSMB){
	fstream fileIn1("E:\\Bài\\Code\\do an\\maybay.txt", ios::in | ios::binary);
	while (!fileIn1.eof()) {
		DSMB.data[++DSMB.n] = new PData;
...
void SaveChuyenBay(listFlight cb) {
	...
	fstream fileOut2("E:\\Bài\\Code\\do an\\chuyenbay.txt", ios::out | ios::binary);
...
void LoadChuyenBay(listFlight &cb) {
	int sizeFlight = sizeof(Flight) - sizeof(Ticket*);
	int SoChuyenBay;
	fstream fileIn2("E:\\Bài\\Code\\do an\\chuyenbay.txt", ios::in | ios::binary);
	InitListFlight(cb);
...
void SaveHanhKhach(treeHanhKhach point) {
	fstream fileOut3("E:\\Bài\\Code\\do an\\hanhkhach.txt", ios::out | ios::binary);
...
void LoadHanhKhach(treeHanhKhach &t) {
	fstream fileIn3("E:\\Bài\\Code\\do an\\hanhkhach.txt", ios::in | ios::binary);
	int SoHK;
	HanhKhach hk;
